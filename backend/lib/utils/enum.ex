defmodule FerretRescue.Utils.Enum do
  @moduledoc """
  ...
  By default we store the string version of `name` as the database value, however, you can specify a `db_value`
  option to override that.

  ```
  type: :gender,
  values: [
    %{name: :male, as: :something_else, deprecate: "This is why this is deprecated", description: "Describe the field"},
    %{name: :female},
  ]
  ```
  """
